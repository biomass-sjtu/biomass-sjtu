                        ...
                        <nav>
                            ...
                            <!-- <div class="col-md-4 col-sm-4 col-xs-12" align="center">
                                    <?php if(get_theme_mod('header_text',true)):?>
                                        <a href="<?php echo esc_url(home_url('/')); ?>" rel="home" id='brand' class="custom-logo-link" style="display: inline-block"><span class="site-title"><h4 style="color:#2da031"><b><?php echo esc_html( get_bloginfo( 'name' ) ); ?><br><?php echo esc_html( get_bloginfo( 'description' ) ); ?></b></h4></span></a>
                                        <?php endif; ?>
                            </div> -->
                            <div class="col-md-6 col-sm-6 col-xs-12 mob_nav" style="float: right;">
                                <div class="main-menu"  style="vertical-align:bottom">
                                    <div id='menu-style'>
                                        <?php 
